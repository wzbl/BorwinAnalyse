...
{
    public partial class BoundGridView : KryptonDataGridView
    {
        ...
        public BoundGridView() : base()
        {
            ...
            this.ColumnHeadersDefaultCellStyle.Font = new Font("宋体", 12, FontStyle.Bold);
            this.ColumnHeadersDefaultCellStyle.ForeColor = Color.Purple;
        }
